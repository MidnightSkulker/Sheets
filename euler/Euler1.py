...
# Problem 1
n1000 = [x for x in range(0,1000) if x % 3 == 0 or x % 5 == 0]
sum(n1000)
...
j = 0
while (fib1 < limit):
    print('fib(' + str(j) + ') =', fib0)
    evenFibSum += fib1 if (fib1 % 2 == 0) else 0
    temp = fib1 + fib0
    fib0 = fib1
    fib1 = temp
    print('fib1 = ', fib1)
...
def get_prime_factors(number):
    ...
    # First quick refreshment on the two key mathematical conjectures of Prime
    # factorization of any non-Prime number
    ...
    # ANS to that is - in my first for-loop I am dividing n with the prime
    # number if that prime is a factor of n.
    # Meaning, after this first for-loop gets executed completely,
    # the adjusted initial n should become
